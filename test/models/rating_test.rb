...
class RatingTest < ActiveSupport::TestCase
  ...
  test "promoter? return false if score is greater than 10" do
    rating = Rating.new(score: 11)
    assert_not rating.promoter?
  end
  ...
  test "detractor? return true if score is less than or equal to 6" do
    0.upto(6).each do |i|
      rating = Rating.new(score: i)
  ...
  test "detractor? return false if score is less than 0" do
    rating = Rating.new(score: -1)
    assert_not rating.detractor?
  end
end
